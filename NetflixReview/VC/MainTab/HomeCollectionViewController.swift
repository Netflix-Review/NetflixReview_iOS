...
class HomeCollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(HomeCollectionViewCell.self, forCellWithReuseIdentifier: UICollectionViewCell.reuseIdentifier)
        collectionView.register(HomeHeaderLabel.self, forSupplementaryViewOfKind: HomeCollectionViewController.categoryHeaderId, withReuseIdentifier: headerId)
    }
    ...
    func fetchContentsData() {
        AF.request(URL.baseURL + "/drama", method: .get).validate().responseDecodable(of: [Value].self) { response in
    ...
    func fetchMovieData() {
        AF.request(URL.baseURL + "/movie", method: .get).validate().responseDecodable(of: [Value].self) { response in
    ...
    func fetchTvData() {
        AF.request(URL.baseURL + "/tv", method: .get).validate().responseDecodable(of: [Value].self) { response in
...
extension HomeCollectionViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: UICollectionViewCell.reuseIdentifier, for: indexPath) as! HomeCollectionViewCell
